            ...
            <div class="col mt-2">
                <form id="dataAset" action="/Pencatatan/saveAset" method="post">
                            ...
                            <tr class="line_items">
                                ...
                                <td>
                                    <div class="form-row">
                                        <div class="row">
                                            <div class="col-8">
                                                <input type="number" class="form-control text-right" id="kuantitasAset" min="1" name="kuantitasAset[]" required>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-row">
                                        <div class="row">
                                            <div class="col-8">
                                                <input type="text" class="form-control text-right" id="priceAset" name="priceAset[]" required>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                    ...
                    <div class="row d-flex justify-content-end mt-3">
                        <div class="col-2"><button class="btn btn-success" type="submit" name="simpan-pesanan" onclick="return confirm('Apakah anda yakin?')">Simpan Data Aset</button></div>
