...
<div class="main-content">
    ...
    <section class="section" style="background-color: white; padding: 2rem; box-shadow: 1px 2px 3px 1px rgba(0,0,0,0.75); border-radius: 15px;">
        <div class="row">
            ...
            <div class="col-lg-2">
                <a class="btn btn-info" href="/user/dashboard/product/pembelian"><i class="fas fa-plus"></i> Tambah Pembelian</a>
            </div>
        </div>
        <div class="row">
                ...
                <table id="tabelmenu" class="table table-striped table-sm">
                    <!-- <thead>
                        <tr class="text-center" class="text-center">
                            <th class="table-bordered" style="background-color: #eaeaea;"><a class="text-dark" href="/user/dashboard/product/offline-shipping" style="text-decoration: none;">Offline Shipping</a></th>
                    ...
                    <a class="btn btn-light mr-1 mb-2 text-dark" href="/user/dashboard/product/offline-shipping" style="text-decoration: none;">Offline Shipping</a>
